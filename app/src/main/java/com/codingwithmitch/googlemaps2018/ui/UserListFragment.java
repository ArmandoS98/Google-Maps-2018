...
public class UserListFragment extends Fragment implements
    ...
    private ArrayList<ClusterMarket> mClusterMarkets = new ArrayList<>();
...
//                        Log.d(TAG, "run: latlng: " + latLng.toString());
    ...
    private void retrieveUserLocations(){
        ...
        try{
            for(final ClusterMarket clusterMarker: mClusterMarkets){
                ...
                userLocationRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
                            ...
                            // update the location
                            for (int i = 0; i < mClusterMarkets.size(); i++) {
                                try {
                                    if (mClusterMarkets.get(i).getUser().getUser_id().equals(updatedUserLocation.getUser().getUser_id())) {
                                        ...
                                        mClusterMarkets.get(i).setPosition(updatedLatLng);
                                        myClusterManagerRenderer.setUpdateMarker(mClusterMarkets.get(i));
    ...
    private void addMapMarkers(){
        if (mGoogleMap != null){
            if (mClusterManager == null){
                mClusterManager = new ClusterManager<ClusterMarket>(getActivity().getApplicationContext(), mGoogleMap);
            }
            ...
            for (UserLocation userLocation : mUserLocations){
                ...
                try{
                    ...
                    ClusterMarket newClusterMarket = new ClusterMarket(
                    ...
                    mClusterManager.addItem(newClusterMarket);
                    mClusterMarkets.add(newClusterMarket);
                }catch (NullPointerException e){
    ...
    private void setCameraView(){
        ...
        //Overall map vies window: 0.2 * 0.2 = 0.04
